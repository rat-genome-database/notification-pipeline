    ...
    public void run(Date from, Date to) throws Exception {
        ...
        for (String user: users) {
            ...
            String s = """
                ...
                RGD has retired its legacy login system.  We are now using Google to authenticate.
                If you previously used an email address tied to a Google account your login will work as it did before.
                <br><br>If you used an email account that is not registered with Google you have 3 options:
                <ol>
                <li>Create a Google account using the email address previously used to register on RGD.
                    <a href='https://support.google.com/accounts/answer/27441?hl=en'>https://support.google.com/accounts/answer/27441?hl=en</a></li>
